...
| Name                | Organization | Team          | GitHub                                        | Discord       |
| ------------------- | ------------ | ------------- | --------------------------------------------- | ------------- |
| Charles de Dreuille | Spotify      | Cubic Belugas | [cdedreuille](https://github.com/cdedreuille) | `cdedreuille` |
| Patrik Oldsberg     | Spotify      |               | [Rugvip](https://github.com/Rugvip)           | `Rugvip`      |
